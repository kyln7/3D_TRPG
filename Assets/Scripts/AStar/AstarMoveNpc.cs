...
public class AStarMoveNpc
{
    private static AStarMoveNpc instance;
    ...
    public AStarMoveNpc() { }
    public AStarMoveNpc(Grid[,] map) { aStar = new AStarClass(map, Vector2.zero, Vector2.zero, false, false); }
    public AStarMoveNpc(Grid[,] map, Vector2 start, Vector2 end) { aStar = new AStarClass(map, start, end, false, false); }

    public static AStarMoveNpc GetInstance()
    {
        if (instance == null)
        {
            instance = new AStarMoveNpc();
        }
        return instance;
    }
    ...
    public bool Move(GameObject gameObject, GridArray maparray, Vector2 start, Vector2 end, out Vector2 endPos, User user = User.NPC)
    {
    ...
    private Status MoveStep(GameObject gameObject, User user = User.NPC)
    {
